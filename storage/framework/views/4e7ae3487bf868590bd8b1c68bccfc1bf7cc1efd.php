...
<head>
    ...
    <title>Event Star</title>
    <link rel="shortcut icon" href="<?php echo e(asset('favicon.png')); ?>" type="image/icon">
    ...
    <link rel="stylesheet" href="<?php echo e(asset('assets/css/bootstrap-slider.min.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('assets/css/jquery.scrolling-tabs.min.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('assets/css/bootstrap-checkbox.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('assets/css/flexslider.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('assets/css/featherlight.min.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('assets/css/font-awesome.min.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('assets/css/bootstrap.offcanvas.min.css')); ?>">
