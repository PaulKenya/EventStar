                        ...
                        <table width="600" cellpadding="0" cellspacing="0" border="0" class="container">
                            <tr>
                                <td width="600" class="mobile" align="center" mc:label="the_logo" mc:edit="the_logo">
                                    <img src="<?php echo e(asset('uon_logo.png')); ?>" width="58" height="16" style="margin:0; padding:0; border:none; display:block;" border="0" class="centerClass" alt="" mc:edit="the_image" />
                        ...
                        <table width="600" cellpadding="0" cellspacing="0" border="0" class="container">
                            <tr>
                                <td width="600" class="mobile" style="font-family:arial; font-size:18px; line-height:24px;" align="center" mc:label="the_title" mc:edit="the_title">
                                    Hello <span style="color:#40a7ff;"><strong><?php echo e($name); ?></strong></span>,
                                    ...
                                    <table width="500" class="mobile">
                                        <tr>
                                            <td style="font-family:arial; font-size:14px; line-height:24px; color:#aeaeae;" align="center" mc:label="the_copy" mc:edit="the_copy">
                                                A new <?php echo e($event_type); ?> has been Added. It will be held on the <?php echo e($event_date); ?> at <?php echo e($event_location); ?> starting from <?php echo e($event_time); ?>.
                                                The event is hosted by <?php echo e($event_host); ?> with only <?php echo e($number_of_tickets_available); ?> available.
                                                Grab you tickets right now starting from <?php echo e($price_per_ticket); ?> here at Event Star.
                                            </td>
                                        </tr>
                                    </table>
