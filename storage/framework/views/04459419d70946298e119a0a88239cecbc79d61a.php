        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <p>&copy;<?php echo e(date("Y")); ?> EVENTSTAR.COM. ALL RIGHTS RESERVED</p>
                </div>
            </div>
...
<script src="<?php echo e(asset('assets/js/jquery.scrolling-tabs.min.js')); ?>"></script>
<script src="<?php echo e(asset('assets/js/jquery.countdown.min.js')); ?>"></script>
<script src="<?php echo e(asset('assets/js/jquery.flexslider-min.js')); ?>"></script>
<script src="<?php echo e(asset('assets/js/jquery.imagemapster.min.js')); ?>"></script>
<script src="<?php echo e(asset('assets/js/tooltip.js')); ?>"></script>
<script src="<?php echo e(asset('assets/js/bootstrap.min.js')); ?>"></script>
<script src="<?php echo e(asset('assets/js/featherlight.min.js')); ?>"></script>
<script src="<?php echo e(asset('assets/js/featherlight.gallery.min.js')); ?>"></script>
<script src="<?php echo e(asset('assets/js/bootstrap.offcanvas.min.js')); ?>"></script>
